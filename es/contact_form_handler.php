...
$secretKey = "6LfCsC4UAAAAAAD1Lxq0z8zTTy79VsVpo9YZlQ9q";
$ip = $_SERVER['107.180.51.35'];
...
try {
    ...
    $mail->addAddress('info@ecuadortreasure.com', 'Chuquiragua Lodge');     // Add a recipient
    ...
    $mail->Body    = 'Informacion de email: </br> 
                      ...
                      <b>Telefono: </b>'.$phoneNumber.'
    				  <b>Mensaje: </b>'.$message;
    $mail->AltBody = 'Formulario de contacto en Ecuador Treasure completado. Nombre: '.$name.' Email: '.$email_address.' Telefono: '.$phoneNumber.' Mensaje: '.$message;
